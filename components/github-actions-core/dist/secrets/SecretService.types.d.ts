...
export interface SecretServiceInterface {
     ...
     */
    createRepositorySecret(context: ContextInterface, secret: RepositorySecretInterface): Promise<void>;
    /**
     ...
     * @throws {Error} - if the secret could not be created
     */
    createEnvironmentSecret(context: ContextInterface, secret: EnvironmentSecretInterface): Promise<void>;
}
