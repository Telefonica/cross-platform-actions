...
- The deploy workflow creates a job with a step named `Set ID (${{github.event.inputs.id}})`. This step will be used to verify that the workflow is the one that was launched by this action. 
